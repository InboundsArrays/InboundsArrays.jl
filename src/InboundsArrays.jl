...
if !inherit_from_AbstractArray
    ...
    @inline sum(A::AbstractInboundsArray, args...; kwargs...) = InboundsArray(sum(A.a, args...; kwargs...))
    @inline prod(A::AbstractInboundsArray, args...; kwargs...) = InboundsArray(prod(A.a, args...; kwargs...))
    @inline maximum(A::AbstractInboundsArray, args...; kwargs...) = InboundsArray(maximum(A.a, args...; kwargs...))
    @inline minimum(A::AbstractInboundsArray, args...; kwargs...) = InboundsArray(minimum(A.a, args...; kwargs...))
    @inline extrema(A::AbstractInboundsArray, args...; kwargs...) = InboundsArray(extrema(A.a, args...; kwargs...))
    @inline all(A::AbstractInboundsArray, args...; kwargs...) = InboundsArray(all(A.a, args...; kwargs...))
    @inline any(A::AbstractInboundsArray, args...; kwargs...) = InboundsArray(any(A.a, args...; kwargs...))
